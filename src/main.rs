        ...
        for event in track.iter()
        {
            ...
            if let TrackEventKind::Midi { channel: _, message } = event.kind
            {
                ...
                if let MidiMessage::NoteOn { key: _, vel: _} = message
                {
                    ...
                    silence_durration = (silence_durration / args.BPM as f32) * 60.0;
                ...
                else if let MidiMessage::NoteOff { key, vel: _ } = message
                {
                    ...
                    note_durration = (note_durration / args.BPM as f32) * 60.0;
                    ...
                    let currTone: Vec<f32> = args.wave.gen(note_freq,note_durration);
                    //w.append(currTone);
